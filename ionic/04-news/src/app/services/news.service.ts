...
import { NewsReponse, Article, ArticlesByCategoryAndPage } from '../pages/interfaces';
...
export class NewsService {
  ...
  private getArticlesByCategory( category: string ): Observable<Article[]> {
    ...
    return this.executeQuery<NewsReponse>(`/top-headlines?category=${ category }&page=${ page }`)
    .pipe(
      map( ({ articles }) => {
